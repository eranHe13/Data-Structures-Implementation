...
public class MatrixTest {
	...
	@Test
	public void MytTests() {
		Matrix<Integer> matrix4 = matrixFactory.getMatrix(3, defaultVal);
		try {
			matrix4.set(4,4,4);
		}
		catch (IndexOutOfBoundsException e){ }
		matrix4.set(1,3,4);
		assertTrue(matrix4.get(1,3) == 4);
		matrix4.transpose();
		assertTrue(matrix4.get(3,1) == 4);
		assertTrue(matrix4.get(1,3) == defaultVal);
		matrix4.transpose();
		matrix4.set(1,3,4);
